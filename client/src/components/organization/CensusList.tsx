...
import { Check, ChevronDown, ChevronUp, SearchX } from 'lucide-react';
    ...
    <div>
      <div className="grid gap-1.5 sm:grid-cols-2 lg:grid-cols-3">
        {visible.map(addr => {
          ...
          const className = `flex items-center gap-2 rounded-xl border px-3 py-2 text-left font-mono text-xs transition ${

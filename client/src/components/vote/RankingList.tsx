...
function SortableRow({option, index}: { option: ProposalOption; index: number }) {
    ...
    return (
        ...
        >
            <div
                className="flex size-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-accent font-display text-lg font-bold text-primary-fg">
                {index + 1}
            </div>

...
export function VoteReceipt({ open, onClose, proposalTitle, ranking, txId }: VoteReceiptProps): JSX.Element {
		...
		<AnimatePresence>
			{open && (
				<>
					...
					>
						{/* Drag handle */}
						<div className="flex cursor-grab justify-center pb-2 pt-4 active:cursor-grabbing">

...
function BallotBoxGeometry() {
    return (
        <>
            ...
            <line
                x1={C.fTR.x} y1={C.fTR.y} x2={C.bTR.x} y2={C.bTR.y} stroke="rgb(var(--primary) / 0.55)"
                strokeWidth="1.1"
            />
            <line
                x1={C.fBR.x} y1={C.fBR.y} x2={C.bBR.x} y2={C.bBR.y} stroke="rgb(var(--primary) / 0.38)"
                strokeWidth="1"
            />

            <line
                x1={C.bTL.x} y1={C.bTL.y} x2={C.bBL.x} y2={C.bBL.y} stroke="rgb(var(--primary) / 0.45)"
                strokeWidth="1" strokeDasharray="4 3"
            />
            <line
                x1={C.fBL.x} y1={C.fBL.y} x2={C.bBL.x} y2={C.bBL.y} stroke="rgb(var(--primary) / 0.38)"
                strokeWidth="1" strokeDasharray="4 3"
            />
            <line
                x1={C.bBL.x} y1={C.bBL.y} x2={C.bBR.x} y2={C.bBR.y} stroke="rgb(var(--primary) / 0.38)"
                strokeWidth="1" strokeDasharray="4 3"
            />
            ...
            <g transform={`translate(${(F.x1 + F.x2) / 2 - 30}, ${F.y2 - 52})`}>
                <rect
                    ...
                    stroke="rgb(var(--primary) / 0.9)" strokeWidth="1.3"
                />

                <polyline
                    points="14,17 23,25 46,9"
                    fill="none"
                    stroke="rgb(var(--primary))" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"
                />
            </g>
        </>
    );
    ...
    return (
        ...
        >
            <g transform="translate(-22, -15)">
                <rect
                    x="0" y="0" width="44" height="30" rx="3"
                    fill="rgb(var(--elevated))"
                    stroke={`hsl(${ballot.hue} 55% 40%)`} strokeWidth="1"
                />
                <rect x="0" y="0" width="44" height="8" rx="3" fill={`hsl(${ballot.hue} 75% 60%)`}/>
                <rect x="0" y="6" width="44" height="2" fill={`hsl(${ballot.hue} 60% 45%)`}/>
                <rect
                    x="4" y="13" width="9" height="9" rx="1"
                    fill={`hsl(${ballot.hue} 80% 55%)`}
                    stroke={`hsl(${ballot.hue} 60% 40%)`} strokeWidth="0.6"
                />
                <polyline
                    points="5.5,17 8,19.5 12,14.5" fill="none" stroke="rgb(255 255 255)"
                    strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"
                />
                <line
                    x1="16" y1="15" x2="40" y2="15"
                    stroke={`hsl(${ballot.hue} 25% 45%)`} strokeWidth="1.2" strokeLinecap="round"
                />
                <line
                    x1="16" y1="19" x2="34" y2="19"
                    stroke={`hsl(${ballot.hue} 20% 55%)`} strokeWidth="1" strokeLinecap="round"
                />
                <line
                    x1="4" y1="25" x2="36" y2="25"
                    stroke={`hsl(${ballot.hue} 20% 60%)`} strokeWidth="0.8" strokeLinecap="round"
                />
            </g>
        </m.g>
    );

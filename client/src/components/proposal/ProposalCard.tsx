import type { Proposal, OrganizationId } from '@/domain'
import type { JSX } from 'react'

import { approvalPercentage } from '@/domain'
...
export function ProposalCard({ proposal, orgName, orgId, locked }: Props): JSX.Element {
	...
	return (
		<a
			...
			tabIndex={0}
			onKeyDown={event => event.key === 'Enter' && navigate(`/proposals/${proposal.id}`)}

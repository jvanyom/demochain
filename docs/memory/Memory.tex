...
\include{capitols/Introduccio}
\include{capitols/EstatDelArt}
\include{capitols/Planificacio}
\include{capitols/Disseny}
\include{capitols/Desenvolupament}
\include{capitols/Conclusions}
\include{capitols/Us_ia}

...
La seva contribució fonamental és la combinació de \emph{mixnets} per garantir l'anonimat dels vots i xifratge ElGamal~\cite{elgamal1985public}
amb proves de coneixement zero~\cite{goldwasser1989knowledge} per permetre que qualsevol persona pugui verificar que els vots s'han inclòs al recompte
...
conceptual d'Helios.
Aporta dues novetats principals: xifratge \emph{threshold} ElGamal~\cite{elgamal1985public} i una cerimònia de desxifrat distribuïda entre
...
Empra, com Belenios, ElGamal~\cite{elgamal1985public} \emph{threshold} amb proves de coneixement zero~\cite{goldwasser1989knowledge}.
...
d'estat verificada amb proves \acp{ZK-SNARK}~\cite{goldwasser1989knowledge,groth2016size} i xifratge \emph{threshold} ElGamal~\cite{elgamal1985public} per garantir privacitat del vot.
Inclou també mecanismes de resistència a la coacció (\emph{receipt-freeness})~\cite{benaloh1994receiptfree} que impedeixen al votant demostrar a un

...
través d'un node Ethereum. En producció aquest últim queda fora del \textit{software} del projecte (s'utilitza un
proveïdor de la testnet d'Ethereum, Sepolia); per al desenvolupament local s'inclou un node Hardhat dins del mateix
\texttt{docker-compose} que desplega automàticament el contracte.

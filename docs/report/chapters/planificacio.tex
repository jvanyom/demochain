...
\begin{itemize}
    ...
    \acsp{ZK-SNARK} Groth16, cerimònies de desxifrat amb \emph{trustees}) va revelar una complexitat que excedia el
...
\begin{itemize}
    ...
    \item El codi viu en una branca específica i una \ac{PR} està oberta contra \texttt{dev}.
...
\begin{table}[ht]
    ...
    \begin{tabular}{@{}llp{5cm}cc@{}}
        ...
        \#413       & E8            & Ancoratge de resultats a Ethereum         & Tancada        & Sí              \\
        \#402       & E11           & Setup del projecte i del repositori       & Tancada         & Sí              \\
        \#520       & E12           & Entrega final del projecte                & Tancada        & Sí              \\
        \bottomrule
    \end{tabular}
    \caption[Inventari d'èpiques]{Inventari d'èpiques del projecte.}
    \label{tab:epiques}
\end{table}
...
\begin{itemize}
    ...
    \item Proves \acsp{ZK-SNARK} Groth16 per acreditar l'elegibilitat del votant sense revelar-ne la identitat.

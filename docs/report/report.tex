...
\usepackage{amsmath,mathtools,amstext}
...
% Evita que los flotantes (figuras, tablas) salten de sección o subsección.
\usepackage[section]{placeins}
\usepackage{etoolbox}
\pretocmd{\subsection}{\FloatBarrier}{}{}

% Evita viudes i orfes (línies soles al final/inici de pàgina)
\widowpenalty=10000
\clubpenalty=10000


% Permite cortar URLs largas en más puntos para evitar que se salgan del margen.
\usepackage{xurl}
...
\usepackage[backref, colorlinks=true, hypertexnames=false]{hyperref}
...
%\includeonly{Acronimos, Introduccion, Estado-actual-hosp}
...
% del document que ens interessi.
    ...
    \include{chapters/introduccio}
    \include{chapters/estat-de-l-art}
    \include{chapters/planificacio}
    \include{chapters/analisi}
    \include{chapters/disseny}
    \include{chapters/desenvolupament}
    \include{chapters/conclusions}
    \include{chapters/us-ia}
    \include{chapters/annexos}

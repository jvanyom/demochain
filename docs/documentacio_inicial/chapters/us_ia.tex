...
Eina utilitzada per generar prototips ràpids d'interfície i explorar possibles estructures visuals durant la fase de disseny del \textit{front-end}.
...
Aquest enfocament reflecteix la realitat actual de l'enginyeria de \textit{software} moderna, on els assistents basats en intel·ligència artificial s'estan integrant progressivament en els fluxos de treball dels desenvolupadors.

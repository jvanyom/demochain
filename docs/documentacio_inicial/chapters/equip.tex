...
\begin{quote}
    Aporta experiència prèvia en la realització de proves i testatge de \textit{software}. És una persona molt curiosa que necessita reptes analítics constants per investigar on i com pot fallar un sistema.
\end{quote}

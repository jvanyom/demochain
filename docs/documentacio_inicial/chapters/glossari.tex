...
\item \hypertarget{def:\textit{hash}}{\textbf{\textit{hash} criptogràfic}} Funció matemàtica que transforma dades en una empremta digital única i irreversible.
...
\item \hypertarget{def:\textit{front-end}}{\textbf{\textit{front-end}}} Part visible del sistema amb la qual interactua l'usuari.

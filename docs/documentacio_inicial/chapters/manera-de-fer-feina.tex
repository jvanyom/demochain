...
\begin{itemize}
    ...
    \item El codi ha de respectar una estructura de directoris modular (p. ex., /contracts, /frontend) i les funcions principals han de comptar amb comentaris descriptius.

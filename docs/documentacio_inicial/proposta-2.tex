...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}
        ...
        \item \textit{Competències i justificació:} Experiència en creació d'API REST (Node.js)  i protocols d'autenticació (JWT). La dedicació en ciberseguretat és vital per gestionar de manera robusta el \textit{hashing} de credencials de vot.
    ...
    \begin{itemize}
        \item \textit{Rols:} Desenvolupador Frontend (80\%) i Responsable de QA / Proves (20\%).
...
\textbf{9 -- 11} & \textbf{Front-End i Connexió Web3} & \textbf{Rol Front:} Creació d'interfície interactiva (React). \textbf{Rols BC/Back:} Connexió mitjançant Ethers.js i proves de crides als contractes intel·ligents. & API i Contracts operatius. \\ \hline
...
\textit{Nota sobre el camí crític:} La lògica del Smart Contract requereix l'aprovació completa a la Setmana 8. Qualsevol retard en aquesta fase endarreriria el desenvolupament del Frontend Web3. Per mitigar-ho, s'utilitzaran \textit{mocks} de dades perquè el Frontend avanci mentre el contracte assoleix la fase de producció.
...
4. Desenvolupament Frontend (UI/Web3) & 0 & 0 & 4 & 34 & \textbf{38} \\ \hline
